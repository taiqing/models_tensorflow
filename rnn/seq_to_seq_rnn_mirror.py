    ...
    def __build_graph__(self):
        ...
        with self.graph.as_default():
            ...
            for t in range(self.n_step):
                ...
                x_t = initial_input if t == 0 else x[:, self.n_step - t, ::-1] # vertical flipping
            ...
            # loss
            loss = tf.reduce_mean(tf.squared_difference(outputs, x[:, :, ::-1]))
...
if __name__ == '__main__':
    ...
    error = np.mean((y - test_x[:, :, ::-1]) * (y - test_x[:, :, ::-1]))
